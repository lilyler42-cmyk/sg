var TGAdsShow = (function() {
    var l = document,
        ...
        adJsPre = '//game.qq.com/time/qqadv/Info_new_',
        adImgPre = '//ossweb-img.qq.com/upload/adw/',
        sendClickUrl = '//apps.game.qq.com/adw_sendclick/api/send_click.php',
        LogCgi = "//apps.game.qq.com/eas/comm/eas.php",
        LogCgiGo = '//logs.game.qq.com/easnew/go/eas.php', // http://logs.game.qq.com/easnew/go/eas.php
    ...
    if (preview != null) {
        ...
        if (env == 'DevelopEcho') {
            adJsPre = '//echoweb.qq.com/data/ad/js/qqadv/Info_new_';
            adImgPre = '//echoweb.qq.com/data/ad/img/';
            sendClickUrl = '//echoweb.qq.com/apps/adw_sendclick/api/send_click.php';
        } else if (env == 'Develop') {
            adJsPre = '//game.qq.com/time/qqadv_develop/Info_new_';
            adImgPre = '//ossweb-img.qq.com/upload/adw_develop/';
            sendClickUrl = '//apps.game.qq.com/adw_sendclick/api/send_click.php';
        } else if (env == 'Beta') {
            adJsPre = '//game.qq.com/time/qqadv_beta/Info_new_';
            adImgPre = '//ossweb-img.qq.com/upload/adw_beta/';
            sendClickUrl = '//apps.game.qq.com/adw_sendclick/api/send_click.php';
        } else {
            adJsPre = '//game.qq.com/time/qqadv/Info_new_';
            adImgPre = '//ossweb-img.qq.com/upload/adw/';
            ...
            if (b == k.toString().substring(3)) {
                ...
                if (d.attributes[strAttribute]) {
                    if (f) {
                        ...
                        d.onclick = function() {
                            ...
                            script.onload = script.onreadystatechange = function() {
                                if (!this.readyState || this.readyState === "loaded" || this.readyState === "complete") {
                                    ...
                                    var ShowAdClick = a + "." + b + "." + strlistdate + "." + tas_code + "." + f[12];
                                    // 由于https访问报错，暂且取消上报
                                    var ShowAdClickUrl = LogCgiGo + '?m=SendLog&show_ads=' + ShowAdClick + '&ad_url=' + encodeURIComponent(strHref) + '&click_type=2&t=' + (new Date()).getTime();
                                    fn.loadjs(ShowAdClickUrl, function() {

                                    });

                                    pgvSendClick({
                                        hottag: "adClick." + a + "." + b + "." + strlistdate + "." + tas_code + "." + f[12]
                                    });
                                    //}
                                }
                            };
                            // script.src = '//pingjs.qq.com/tcss.ping.js';
							script.src = (location.protocol == 'https:') ? 'https://pingjs.qq.com/ping_tcss_https.js' : '//pingjs.qq.com/tcss.ping.js';
                        ...
                        /*曝光数据上报*/
                        /*批量一次上报，减少请求次数*/
                        var ShowAdInfo = a + "." + b + "." + strlistdate + "." + tas_code + "." + f[12];
                        ...
                        if (_c == arrLength - 1) {
                            ...
                            var ShowUrl = LogCgiGo + '?m=SendLog&show_ads=' + ShowAdStr + '&click_type=1&t=' + (new Date()).getTime();
                            //} else {
